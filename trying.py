...
# Initialize the tracker outside the run1 function
tracker = Sort(max_age=20, min_hits=3, iou_threshold=0.3)

def run1(frame, h_w, weights='yolov8m.pt'):
    ...
    for d in trackers_res:
        ...
        cvzone.putTextRect(frame, f'id:{int(track_id)} ', (max(0, int(x1)), max(0, int(y1))), 2, 2, colorT=(255, 255, 255),
                           colorR=(0, 0, 255))
